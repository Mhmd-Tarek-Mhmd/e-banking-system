...
function AdminPanel() {
  ...
  return (
    <div style={{ height: "1000px" }}>
      ...
      {activeItem === "Active_Accounts" && <Active_Account />}
      {activeItem === "Suspend_Accounts" && <Suspend_Account />}
      {activeItem === "Blocked" && <Blocked_Account />}
      {activeItem === "Closed_account_bank" && <Closed_Account_Bank />}
      {activeItem === "Blocked_account_bank" && <Blocked_Account_Bank />}
      {activeItem === "Closed" && <Closed_Account />}
      {activeItem === "Open_account_bank" && <Open_Account_Bank />}
      {activeItem === "Open" && <Open_Account />}
      {activeItem === "Transaction log" && <Transaction />}
      {activeItem === "Process log" && <Process />}
    </div>
  );
}
